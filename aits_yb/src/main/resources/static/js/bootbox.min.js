...
function showWarningAlert(message, obj) {
    bootbox.alert({
        message: message,
        callback: function() {
            setTimeout(function() {
...
function showCommonWarningAlert(message, obj) {
    bootbox.alert({
        message: message,
        callback: function() {
            setTimeout(function() {
...
function showSelect2WarningAlert(message, obj) {
    bootbox.alert({
        message: message,
        callback: function() {
            setTimeout(function() {
                obj.data('select2').open();
            }, 10);
        }
    });
}

function showCheckBoxRadioAlert(message, obj) {
    bootbox.alert({
        message: message,
        callback: function() {
            setTimeout(function() {
...
function showRadioAlert(message, obj) {
    bootbox.alert({
        message: message,
        callback: function() {
            setTimeout(function() {
